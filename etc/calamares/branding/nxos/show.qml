        ...
        ColumnLayout {
            ...
            Text {
                ...
                text: qsTr("Wayland replaces the X11 window system protocol and architecture to be easier to develop, extend, and maintain.\n"
                           ...
                           + "A core part of Wayland architecture is libwayland: an inter-process communication library that translates a protocol definition in XML to a C language API. This library does not implement Wayland; it merely encodes and decodes Wayland messages. The actual implementations are in the various compositor and application toolkit projects.n"
