        ...
        ColumnLayout {
            ...
            Text {
                ...
                text: qsTr("Nitrux at a glance\n"
                           ...
                           + " • Nitrux is very up-to-date, thanks to its use of a recent Debian base and the Psycachy kernel, an enthusiast Linux kernel with patches from CachyOS. Nitrux includes additional performance enhancements, such as allowing “inodes” to be placed at any location on the filesystem, compression using zstd with compression at level 6, and verification of compressed blocks using a checksum to avoid corruption.\n\n"
        ...
        ColumnLayout {
            ...
            Text {
                ...
                text: qsTr("An immutable operating system remains unchangeable after installation, providing a degree of certainty. In the case of Nitrux OS, it maintains the immutability of the root directory, safeguarding its original content.\n\n"
                           ...
                           + "NX Overlayroot is a tool that utilizes OverlayFS, a union filesystem implementation. OverlayFS presents a unified view of two different filesystems; the presented filesystem results from overlaying one filesystem over another. OverlayFS presents the object from the upper filesystem and hides the object from the lower filesystem if a particular object exists in both the upper and lower filesystems.\n\n"
