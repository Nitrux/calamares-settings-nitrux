        ...
        ColumnLayout {
            ...
            Text {
                ...
                text: qsTr("Nitrux at a glance\n"
                           ...
                           + " • Nitrux is very up-to-date, thanks to its use of a recent Debian base and an enthusiast Linux kernel with patches from CachyOS. Nitrux includes additional performance enhancements, such as allowing “inodes” to be placed at any location on the filesystem, compression using zstd with compression at level 6, and verification of compressed blocks using a checksum to avoid corruption.\n\n"
